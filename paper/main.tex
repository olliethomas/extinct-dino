...
\addauthor{Oliver Thomas}{http://www.vision.inst.ac.uk/~ss}{1}
\addauthor{Myles Bartlett}{http://www.vision.inst.ac.uk/~pp}{1}
\addauthor{Thomas Kehrenberg}{colin@collaborators.com}{1}
...
\rule{0pt}{1ex}\hspace{2.24mm}\includegraphics[width=2.33cm]{assets/eg1_largeprint.png}\\[-0.1pt]}}}&
\bmvaHangBox{\fbox{\includegraphics[width=2.8cm]{assets/eg1_largeprint.png}}}&
\bmvaHangBox{\fbox{\includegraphics[width=5.6cm]{assets/eg1_2up.png}}}\\
(a)&(b)&(c)
\end{tabular}
